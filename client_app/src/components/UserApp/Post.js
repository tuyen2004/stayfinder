  ...
  return (
    <div >
      ...
      <div style={{ marginBottom: '20px' }}>
        <p style={{ marginBottom: '15px', fontWeight:'bold', fontSize:'20px' }}>TIN THƯỜNG</p>
            ...
            return (
             ...
             <p> {countimages} </p>
                ...
                <div style={{ padding: '0px 10px' }}>
                  <p style={{ color: 'black', overflowWrap: 'break-word', marginTop: '10px', fontSize:'15px' }}>{post.title}</p>
